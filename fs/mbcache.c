			  ...
			  u64 value, bool reusable)
{
	...
	/*
	 * Scan the bucket's in-progress request list first, then the hash
	 * list, to detect a racing entry creation without allocating memory
	 * that may end up being discarded.
	 */
